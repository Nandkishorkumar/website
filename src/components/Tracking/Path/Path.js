...
const Path = () => {
  const breadcrumbs = [
    ...
    <Typography key="3" style={{color:"#70A42F", fontFamily: 'Montserrat' ,
    FontStyle:'normal' , fontWeight: 'bold' , fontSize:'12px' , lineHeight: '15px'}} className="breadcrumlink">Your Details</Typography>,
  ];
