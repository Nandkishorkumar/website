...
const CartItem = ({ item }: CartItemProps) => {
  ...
  return (
    ...
    >
      ...
      <button
        className="w-7 h-7 ml-3 -mr-2 flex items-center justify-center flex-shrink-0 rounded-full text-gray-400 transition-all duration-200 focus:outline-none hover:bg-gray-100 focus:bg-gray-100 hover:text-red-600 focus:text-red-600"
