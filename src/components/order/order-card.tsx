...
const OrderCard: React.FC<OrderCardProps> = ({ onClick, order, isActive }) => {
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center border-b border-gray-200 py-3 px-5 md:px-3 lg:px-5 ">
        <span className="font-bold text-base md:text-sm lg:text-base text-heading">
          Order
