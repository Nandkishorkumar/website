                    ...
                    {data?.types?.map(({ id, name, slug, icon }) => (
                      <div key={id}>
                        <button
                          ...
                          className="flex space-x-4 items-center w-full px-5 py-2.5 text-sm font-semibold capitalize text-gray-600 transition duration-200 hover:text-primary focus:outline-none"
                        >
                          {icon && (
